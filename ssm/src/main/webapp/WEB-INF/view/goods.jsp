        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="createtime1" class="" id="txt_search_createtime" >
			       <input type="date" name="createtime2" class="" id="txt_search_createtime" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>商品名称：</td>
								<td><input type="text" id="name" name="name" class="" aria-required="true" required/></td>
							</tr>
							<tr>	
								<td>商品价格：</td>
								<td><input type="text" id="price" name="price" class="" aria-required="true" required/></td>
							</tr>
							<tr>	
								<td>商品编号：</td>
								<td><input type="text" id="code" name="code" class="" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>状态：</td>
								<td colspan="4">
							...
							<tr>
								<td>所属分类：</td>
								<td colspan="4">
									<select class="" name="typeid" id = "typeid" aria-required="true" required>
										<option value="">---请选择---</option>
										<c:forEach items="${tList }" var="t">
										 	<option value="${t.id }">${t.typename }</option>
										</c:forEach>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            createtime1: $("#txt_search_createtime").val(),
	            createtime2: $("#txt_search_createtime").val(),
